              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $requests = $conn->query('SELECT * FROM stock_request WHERE status="0" AND rejected="0" GROUP BY doc_number') or die($conn->error);
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="view_request.php?doc=<?php echo $row['doc_number'];?>&emp=<?php echo $row['employee']; ?>">
                          <button type="" class="btn btn-primary">View</button>
                        </a>
                      </td>
                      <td>
                        <a href="issue.php?doc=<?php echo $row['doc_number'];?>&accept=1">
                          <button type="" class="btn btn-success">Accept</button>
                        </a>
                        <a href="issue.php?doc=<?php echo $row['doc_number'];?>&reject=1">
