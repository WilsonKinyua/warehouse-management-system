                ...
                <table id="Sales_table" class="table table-bordered table-striped"  style="overflow-x:auto;">
                  ...
                  if($_POST['id'] == 'all' and $_POST["store_code"] == "all") {
                        ...
                        $res = $conn->query(
                          ...
                          "SELECT users.name, FORMAT(sum(`sale_price` * `quantity`), 2) As amount FROM new_sale 
                    ...
                    $res = $conn->query(
                        ...
                        "SELECT  users.name, FORMAT(sum(`sale_price` * `quantity`),2) As amount, products.vendor FROM new_sale 
                        ...
                        Group By products.vendor, users.name ORDER BY  users.name"
