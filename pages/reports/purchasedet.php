                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      if($_POST['store_code'] == 'all') {
                        ...
                        $res = $conn->query(
                            ...
                            "SELECT stock_detail.id, stock_detail.date, stock_detail.doc_number, supplier.name AS supplier, stores.name AS nstore, products.name AS product, stock_detail.trn_qty AS qty, stock_detail.total_amount AS amount FROM `stock_detail` 
