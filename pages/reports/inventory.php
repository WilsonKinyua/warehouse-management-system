...
function fill_stores($conn) {

  $sql = "SELECT id, code, name FROM stores order by name";
  $output = '';
  $result = $conn->query($sql) or die($conn->error);
  while ($row=$result->fetch_assoc()) {
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Current Inventory Levels :  Main Store & Mobile Shops</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <select class="form-control" name="shop" id="store">
                      <option value="all">All Stores</option>
                      <?php echo fill_stores($conn); ?>
                    </select>
                  </div>
                ...
                <tr>
                  ...
                  $sql = "SELECT *, products.name as pname, products.price as unit_cost, (stock.quantity_available * products.price) total_cost FROM stock INNER JOIN products ON stock.product=products.id";
                  $result = $conn->query($sql) or die($conn->error);
