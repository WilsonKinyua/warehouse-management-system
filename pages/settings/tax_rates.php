          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add a Tax Rate</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <span style="color: red;"><?php echo $tax_name_err; ?></span>
                  </div>
                ...
                <div class="card-footer">
                  <?php if ($update) :?>
                  <button type="submit" class="btn btn-primary" name="taxes_update">Update</button>
                  <?php else:?>
                  <button type="submit" class="btn btn-primary" name="taxes_submit">Submit</button>
                <?php endif;?>
                </div>
              </div>
            </form>
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $number =1;
                    $res = $conn->query("SELECT * FROM tax_rates") or die($conn->error);
