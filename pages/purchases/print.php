...
$pdf->Cell(130 ,5,'GEMAD .CO',0,0);
$pdf->Cell(59 ,5,'INVOICE',0,1);//end of line

//set font to arial, regular, 12pt
$pdf->SetFont('Arial','',12);

$pdf->Cell(130 ,5,'CBD',0,0);
$pdf->Cell(59 ,5,'',0,1);//end of line

$pdf->Cell(130 ,5,'Embu Town',0,0);
...
$pdf->Cell(25 ,8,'Cost',1,0);
$pdf->Cell(25 ,8,'Subtotal',1,1);//end of line
...
$sql="SELECT * FROM products WHERE id IN (";
        ...
        while($row=$query->fetch_assoc()){
          ...
          $pdf->Cell(25 ,8,$row['price'],1,0);
      		$pdf->Cell(25 ,8,$_SESSION['cart'][$row['id']]['quantity'],1,0);
      		$pdf->Cell(25 ,8,$subtotal,1,1);
...
$pdf->SetFont('Arial','B',12);
$pdf->Cell(70 ,8,'',0,0);
$pdf->Cell(50 ,8,'Subtotal Kshs. ',0,0);
$pdf->Cell(25 ,8,''.$totalprice,1,1);//end of line

$pdf->Cell(70 ,8,'',0,0);
$pdf->Cell(50 ,8,'Discount Kshs. ',0,0);
$pdf->Cell(25 ,8,'0.00',1,1);//end of line

$pdf->Cell(70 ,8,'',0,0);
$pdf->Cell(50 ,8,'Total Due Kshs. ',0,0);
$pdf->Cell(25 ,8,''.$totalprice,1,1);//end of line


//make a dummy empty cell as a vertical spacer
$pdf->Cell(189 ,10,'',0,1);//end of line
$pdf->Cell(110 ,8,'Recieved By:',0,1);
$pdf->SetFont('Arial','',12);
